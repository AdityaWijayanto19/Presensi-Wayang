                ...
                <div class="p-4">
                    <form action="/presensi/cetaklaporan" method="POST">
                        ...
                        <div class="space-y-2">
                            ...
                            {{-- Unit Perusahaan --}}
                            <x-admin.select name="unit" id="unit" label="Unit Perusahaan <span class='text-red-500'>*</span>" required>
                            ...
                            {{-- Karyawan --}}
                            <x-admin.select name="nik" id="nik" label="Karyawan <span class='text-red-500'>*</span>" required>
                                <option value="">Pilih Karyawan</option>
                            </x-admin.select>

                            {{-- Button Download --}}
                            <div class="mt-2">
                                <x-admin.button variant="primary" icon="download" type="submit" block name="cetak">Download PDF</x-admin.button>
                            </div>
