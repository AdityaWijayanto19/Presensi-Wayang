...
<div id="adminPreviewBackdrop"
    ...
    <div
        ...
        <div style="display:flex; gap:8px; padding:14px 20px; border-top:1px solid #f0ece8; justify-content:flex-end;">
            <a id="adminModalDownload" href="#" download
                class="px-4 py-2 text-sm font-medium border border-slate-300 text-slate-700 rounded-lg hover:bg-slate-50 transition-colors">Download</a>
            <a id="adminModalOpenTab" href="#" target="_blank"
                class="px-4 py-2 text-sm font-medium bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">Buka
                di Tab Baru</a>
        </div>
    </div>
</div>
        ...
        document.addEventListener('click', function(e) {
            ...
            if (['jpg', 'jpeg', 'png', 'webp'].includes(ext)) {
                ...
                body.innerHTML =
                    ...
                    ext + '</p><p><a href="' + url +
                    '" target="_blank" class="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium">Buka di Tab Baru</a></p></div>';
            }
        });
