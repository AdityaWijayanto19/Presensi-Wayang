...
<body class="bg-[#e9ecef]">
    ...
    <div id="filePreviewBackdrop" class="file-modal-backdrop fixed inset-0 z-[99999] bg-[rgba(20,12,6,0.55)] backdrop-blur-sm hidden items-center justify-center p-4" aria-hidden="true">
        <div class="bg-white rounded-2xl w-full max-w-[640px] max-h-[85vh] flex flex-col overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.3)]" style="animation: modalIn 0.2s ease;" role="dialog" aria-modal="true">
            <div class="flex items-center justify-between px-5 py-4 border-b border-[#f0ece8] shrink-0">
                ...
                <button type="button" class="w-9 h-9 rounded-full inline-flex items-center justify-center bg-[#f5f5f4] border border-[#e7e5e4] text-[#57534e] cursor-pointer hover:bg-[#e7e5e4] shrink-0" id="fileModalClose" aria-label="Tutup">
            ...
            <div class="flex gap-2 p-3.5 px-5 border-t border-[#f0ece8] flex-wrap justify-end bg-white">
                <a id="fileModalDownload" href="#" download class="inline-flex items-center gap-1.5 py-2 px-4 rounded-full text-[13px] font-semibold border-[1.5px] cursor-pointer leading-none no-underline bg-white border-[#e7e5e4] text-[#44403c] hover:border-[#a8a29e]" rel="noopener">
                    <i data-lucide="download"></i> Download
                </a>
                <a id="fileModalOpenTab" href="#" target="_blank" rel="noopener" class="inline-flex items-center gap-1.5 py-2 px-4 rounded-full text-[13px] font-semibold border-[1.5px] cursor-pointer leading-none no-underline bg-coklat border-coklat text-white hover:bg-coklat-dark hover:border-coklat-dark">
